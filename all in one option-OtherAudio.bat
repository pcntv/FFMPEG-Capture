...
set videoCodec=-map v:0 -map a:1 -c:v libx264 -s 1280x720 -crf 18 -profile:v main -level 3.1 -pix_fmt yuv420p -maxrate 4000000 -bufsize 4000001 
set audioCodec=-c:a aac -b:a 128k -ar 44100 -af loudnorm=-16:8:-1,bass=g=-9:f=40 -movflags +faststart 
